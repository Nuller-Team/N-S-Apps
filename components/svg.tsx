export function Notifications_Flatline() {
  return (
    <svg
    ...
    >
      ...
      >
        ...
        <path
          ...
          fill="#231f20"
        ></path>
        <path d="M203.28,58.82s-3.44,1.25-4.42-2.24" fill="#fff"></path>
        <path
        ...
        ></path>
        <path
          d="M280.47,36.18H237.63a4.49,4.49,0,0,0-4.48,4.49V63.53A4.49,4.49,0,0,0,237.63,68h5.18v9L248,68h32.44A4.49,4.49,0,0,0,285,63.53V40.67A4.49,4.49,0,0,0,280.47,36.18Z"
          fill="#fff"
        ></path>
        <path
          d="M242.81,77.48a.3.3,0,0,1-.13,0,.48.48,0,0,1-.37-.48V68.52h-4.68a5,5,0,0,1-5-5V40.67a5,5,0,0,1,5-5h42.84a5,5,0,0,1,5,5V63.53a5,5,0,0,1-5,5H248.31l-5.07,8.71A.48.48,0,0,1,242.81,77.48Zm-5.18-40.8a4,4,0,0,0-4,4V63.53a4,4,0,0,0,4,4h5.18a.5.5,0,0,1,.5.5v7.11l4.28-7.36a.52.52,0,0,1,.44-.25h32.44a4,4,0,0,0,4-4V40.67a4,4,0,0,0-4-4Z"
          fill="#d1d3d4"
        ></path>
        <g id="_5xpas6.tif" data-name="5xpas6.tif">
          <path
            d="M259,59.64h-7.88a.55.55,0,0,1-.58-.48.54.54,0,0,1,.1-.41c.32-.47.64-.94.94-1.42a7.8,7.8,0,0,0,1.17-2.86,3.6,3.6,0,0,0,0-.66V49.55a6.94,6.94,0,0,1,.4-2.39,5.49,5.49,0,0,1,1.49-2.29,5.84,5.84,0,0,1,2.52-1.38c.09,0,.12-.05.12-.14s0-.45,0-.67a1.69,1.69,0,0,1,3.36-.25,6.76,6.76,0,0,1,0,.9c0,.1,0,.14.13.17a5.69,5.69,0,0,1,3.86,3.35,6.1,6.1,0,0,1,.51,2.27c0,.82,0,1.65,0,2.47s0,1.45,0,2.18a5.18,5.18,0,0,0,.5,2.22,15.79,15.79,0,0,0,1.44,2.44l.22.32a.55.55,0,0,1,0,.6.54.54,0,0,1-.51.29Zm.58-16.37c0-.19,0-.39,0-.59a.56.56,0,0,0-.53-.56.55.55,0,0,0-.58.46,5.3,5.3,0,0,0,0,.69Z"
            fill="#d1d3d4"
          ></path>
          <path d="M261.61,60.78a2.79,2.79,0,0,1-5.13,0Z" fill="#d1d3d4"></path>
        </g>
        <circle cx="280.68" cy="66.02" r="6.99" fill="#fff"></circle>
        <path
          d="M280.68,73.51A7.49,7.49,0,1,1,288.17,66,7.5,7.5,0,0,1,280.68,73.51Zm0-14A6.49,6.49,0,1,0,287.17,66,6.5,6.5,0,0,0,280.68,59.53Z"
          fill="#d1d3d4"
        ></path>
        <path
          d="M280.24,63.31l-1.68,1.38-.84-1,2.65-2.14h1.31v8.5h-1.44Z"
          fill="#d1d3d4"
        ></path>
      </g>
    </svg>
