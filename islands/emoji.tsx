        ...
        const modalContent = (
            <div className="flex justify-center items-center">
                <div className="bg-white p-4 rounded shadow-md">
                    <img src={imageURL} alt="Generated Emoji" className="w-[40vh] h-[40vh] mx-auto my-4" />
        ...
        <div className="flex items-center justify-center">
            <div className="w-[80vh] min-h-screen m-4">
                ...
                <div className="bg-white px-20 py-10 rounded shadow-md">
                    <div className="mb-4">
                        <label htmlFor="text" className="block text-sm font-medium text-gray-700 mb-1">絵文字にしたい文字を入力</label>
                        <textarea
