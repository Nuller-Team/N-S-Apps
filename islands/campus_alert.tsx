...
export default function Home({ links }: HomeType) {
  ...
  const [lastCharacterAlertCampus, setLastCharacterAlertCampus] = useState<
    string | null
  >(null);
          ...
          <div>
            <div class="my-3">
              ...
              <div class="flex item-center">
                <p class="font-bold text-gray-600 text-sm">
                  <button class="bg-green-500 text-white rounded-full w-5 h-5 hover:bg-green-600 duration-500 m-1">
                    ＋
                  </button>
